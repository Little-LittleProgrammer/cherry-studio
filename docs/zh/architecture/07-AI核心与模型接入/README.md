...
1. [01-AI总体架构与分层.md](./01-AI总体架构与分层.md)
2. [02-一次聊天请求的完整链路.md](./02-一次聊天请求的完整链路.md)
3. [03-aiCore执行引擎详解.md](./03-aiCore执行引擎详解.md)
4. [04-渲染侧AI编排层.md](./04-渲染侧AI编排层.md)
5. [05-插件系统与工具调用.md](./05-插件系统与工具调用.md)
6. [06-MCP集成与扩展能力.md](./06-MCP集成与扩展能力.md)
7. [07-知识库与长期记忆系统.md](./07-知识库与长期记忆系统.md)
8. [08-Agent与Claude Code链路.md](./08-Agent与Claude Code链路.md)
9. [09-可观测性与调试.md](./09-可观测性与调试.md)
10. [10-关键类型与扩展指南.md](./10-关键类型与扩展指南.md)
